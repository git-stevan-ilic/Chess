                                            ...
                                            if(game.difficulty === 2) allEvals.push({moves:[possibleDepth0[i],possibleDepth1[j],possibleDepth2[k]],diff:eval[1]-eval[0]});
                                                ...
                                                for(let l = 0; l < possibleDepth3.length; l++){
                                                    if(possibleDepth3[k]){
                                                        ...
                                                        if(currEvalScore >= evalFilter[evalFilter.length-1] && game.difficulty === 3)
                                                            allEvals.push({moves:[possibleDepth0[i],possibleDepth1[j],possibleDepth2[k],possibleDepth3[l]],diff:eval[1]-eval[0]});
